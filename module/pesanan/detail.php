...
<table class="table-list">
	...
	<?php
		...
		while($rowDetail=mysqli_fetch_assoc($queryDetail)){
			...
			$subtotal = ($subtotal + $tarif)+$biaya_admin;
	?>
	...
	<tr>
		<td class="kanan" colspan="4">Biaya Admin</td>
		<td class="kanan"><?php echo rupiah($biaya_admin); ?></td>
	</tr>
	<tr>
...
<div id="frame-keterangan-pembayaran">
	<p>Silahkan lakukan pembayaran ke Bank BCA.<br/>
		Nomor Account : 0765374635 (A/N Fadillah Wahyu Heryanto).<br/>
